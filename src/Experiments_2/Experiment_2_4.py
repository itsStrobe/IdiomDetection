...
# Split Sets:
print(features_w2v.shape, targets_idiomatic.shape)
w2v_X_train, w2v_X_test, w2v_y_train, w2v_y_test         = train_test_split(features_w2v,   targets_idiomatic, test_size=TEST_SIZE, shuffle=SHUFFLE, random_state=RND_STATE)
scbow_X_train, scbow_X_test, scbow_y_train, scbow_y_test = train_test_split(features_scbow, targets_idiomatic, test_size=TEST_SIZE, shuffle=SHUFFLE, random_state=RND_STATE)
skip_X_train, skip_X_test, skip_y_train, skip_y_test     = train_test_split(features_skip,  targets_idiomatic, test_size=TEST_SIZE, shuffle=SHUFFLE, random_state=RND_STATE)
elmo_X_train, elmo_X_test, elmo_y_train, elmo_y_test     = train_test_split(features_elmo,  targets_idiomatic, test_size=TEST_SIZE, shuffle=SHUFFLE, random_state=RND_STATE)
