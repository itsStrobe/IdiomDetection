...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings - 2 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings.csv" --RESULTS_DIR "./results/Experiment_2_3/Clean_k2/" --EXP_EXT "_k2" \
    --N_CLUSTERS 2 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm - 2 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm + Fazly's Fixedness Metrics - 2 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings - 4 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings.csv" --RESULTS_DIR "./results/Experiment_2_3/Clean_k4/" --EXP_EXT "_k4" \
    --N_CLUSTERS 4 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm - 4 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm + Fazly's Fixedness Metrics - 4 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings - 6 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings.csv" --RESULTS_DIR "./results/Experiment_2_3/Clean_k6/" --EXP_EXT "_k6" \
    --N_CLUSTERS 6 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm - 6 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm + Fazly's Fixedness Metrics - 6 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings - 8 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings.csv" --RESULTS_DIR "./results/Experiment_2_3/Clean_k8/" --EXP_EXT "_k8" \
    --N_CLUSTERS 8 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm - 8 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm + Fazly's Fixedness Metrics - 8 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings - 10 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings.csv" --RESULTS_DIR "./results/Experiment_2_3/Clean_k10/" --EXP_EXT "_k10" \
    --N_CLUSTERS 10 \
    --RND_STATE 42  \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm - 10 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Embeddings + CForm + Fazly's Fixedness Metrics - 10 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings - 2 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings_lemm.csv" --RESULTS_DIR "./results/Experiment_2_3/Lemm_k2/" --EXP_EXT "_lemm_k2" \
    --N_CLUSTERS 2 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm - 2 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm + Fazly's Fixedness Metrics - 2 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings - 4 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings_lemm.csv" --RESULTS_DIR "./results/Experiment_2_3/Lemm_k4/" --EXP_EXT "_lemm_k4" \
    --N_CLUSTERS 4 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm - 4 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm + Fazly's Fixedness Metrics - 4 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings - 6 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings_lemm.csv" --RESULTS_DIR "./results/Experiment_2_3/Lemm_k6/" --EXP_EXT "_lemm_k6" \
    --N_CLUSTERS 6 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm - 6 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm + Fazly's Fixedness Metrics - 6 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings - 8 Clusters"
python36 Experiment_2_3.py --VECTORS_FILE "embeddings_lemm.csv" --RESULTS_DIR "./results/Experiment_2_3/Lemm_k8/" --EXP_EXT "_lemm_k8" \
    --N_CLUSTERS 8 \
    --RND_STATE 42 \
    --SAVE_PLT

echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm - 8 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm + Fazly's Fixedness Metrics - 8 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings - 10 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm - 10 Clusters"
...
echo "Experiment 2-3 : Clustering Proposal - k-Means - Lemmatized Embeddings + CForm + Fazly's Fixedness Metrics - 10 Clusters"
...
echo "Experiment 2-4 : Unsupervised - Cosine Similarity - Embeddings"
...
echo "Experiment 2-5 : Unsupervised - New Metrics - Embeddings -> Cosine Similarity and Overall Fixedness"
...
echo "Experiment 2-5 : Unsupervised - New Metrics - Lemmatized Embeddings -> Cosine Similarity and Overall Fixedness"
...
echo "Experiment 2-5_b : Unsupervised - New Metrics - Embeddings -> Cosine Similarity and Overall Fixedness"
...
echo "Experiment 2-5_b : Unsupervised - New Metrics - Lemmatized Embeddings -> Cosine Similarity and Overall Fixedness"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - PMI Candidates"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - PMI Candidates - Lemmatized"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Lexical Fixedness Candidates"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Lexical Fixedness Candidates - Lemmatized"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Syntactical Fixedness Candidates"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Syntactical Fixedness Candidates - Lemmatized"
python36 Experiment_3_1.py --OG_SENT_DIR "../targets/Extracted_Sentences_cand_SYN_lemm.txt" --VECTORS_FILE "embeddings_cand_SYN_lemm.csv" --VECTORS_FILE_VNC "embeddings_cand_SYN_VNC_lemm.csv" --RESULTS_DIR "./results/Experiment_3_1/SYN_Lemm/"\
    --SVM_W2V   "../SVM_Models/W2V_lemm_cForms.model"   \
    --SVM_SCBOW "../SVM_Models/SCBOW_lemm_cForms.model" \
    --SVM_SKIP  "../SVM_Models/SKIP_lemm_cForms.model"  \
    --SVM_ELMO  "../SVM_Models/ELMO_lemm_cForms.model"  \
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Overall Fixedness Candidates"
...
echo "Experiment 3-1 : Unsupervised - Cosine Similarity [Candidates] - Overall Fixedness Candidates - Lemmatized"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - PMI Candidates"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - PMI Candidates - Lemmatized"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Lexical Fixedness Candidates"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Lexical Fixedness Candidates - Lemmatized"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Syntactical Fixedness Candidates"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Syntactical Fixedness Candidates - Lemmatized"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Overall Fixedness Candidates"
...
echo "Experiment 3-2 : Unsupervised - New Metrics -> Cosine Similarity and Overall Fixedness [Candidates] - Overall Fixedness Candidates - Lemmatized"
